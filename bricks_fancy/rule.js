...
var $rtfeldman$elm_css$Css$Transitions$TextShadow = {$: 'TextShadow'};
var $rtfeldman$elm_css$Css$Transitions$textShadow3 = $rtfeldman$elm_css$Css$Transitions$fullTransition($rtfeldman$elm_css$Css$Transitions$TextShadow);
...
var $author$project$Style$Button$styleButton = A2(
	...
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							1000,
							0,
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
							$rtfeldman$elm_css$Css$Transitions$border3,
							1000,
							0,
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
							$rtfeldman$elm_css$Css$Transitions$bottom3,
							1000,
							0,
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
							...
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
							$rtfeldman$elm_css$Css$Transitions$top3,
							1000,
							0,
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
							$rtfeldman$elm_css$Css$Transitions$textShadow3,
							1000,
							0,
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
							$rtfeldman$elm_css$Css$Transitions$right3,
							1000,
							0,
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
							$rtfeldman$elm_css$Css$Transitions$left3,
							1000,
							0,
							A4($rtfeldman$elm_css$Css$Transitions$cubicBezier, 0.075, 0.82, 0.165, 1)),
							A3(
			...
			_List_fromArray(
				[
					A3($rtfeldman$elm_css$Css$Transitions$background3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$border3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$bottom3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$boxShadow3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$top3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$textShadow3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$right3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$left3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
					A3($rtfeldman$elm_css$Css$Transitions$opacity3, 300, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut)
				]))
		]));
...
var $rtfeldman$elm_css$Css$skewX = function (_v0) {
	var value = _v0.value;
	return {
		transform: $rtfeldman$elm_css$Css$Structure$Compatible,
		value: A2(
...
var $author$project$Style$Title$styleTitle = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
		...
		[
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$pct(250)),
					$rtfeldman$elm_css$Css$overflow($rtfeldman$elm_css$Css$hidden),
					A2($rtfeldman$elm_css$Css$property, 'background', 'linear-gradient(45deg, rgba(255,255,255,0) 45%,rgba(255,255,255,0.8) 50%,rgba(255,255,255,0) 55%,rgba(255,255,255,0) 100%)'),
					$rtfeldman$elm_css$Css$transform(
					$rtfeldman$elm_css$Css$skewX(
						$rtfeldman$elm_css$Css$deg(-25))),
					A2($rtfeldman$elm_css$Css$property, 'animation', '_7d0c44e5 1.5s infinite')
				])),
			$rtfeldman$elm_css$Css$hover(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A3($rtfeldman$elm_css$Css$Transitions$background3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$border3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$bottom3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$boxShadow3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$top3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$textShadow3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$right3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$left3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease),
									A3($rtfeldman$elm_css$Css$Transitions$opacity3, 3000, 0, $rtfeldman$elm_css$Css$Transitions$ease)
								]))
						]))
				])),
			...
			$rtfeldman$elm_css$Css$Animations$keyframes(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($rtfeldman$elm_css$Css$Animations$property, 'left', '-150%')
							])),
						_Utils_Tuple2(
						100,
						_List_fromArray(
...
var $author$project$Rule$view = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'width', '100vw'),
			A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'height', '100vw'),
			...
			A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'overflow-x', 'hidden'),
			A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'overflow-y', 'hidden')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'border-color', 'silver'),
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'border-width', '15px'),
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'border-style', 'outset'),
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'margin', '0 auto'),
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'width', '1000px'),
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'height', '600px'),
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'background', 'linear-gradient(135deg, rgba(206,188,155,1) 0%, rgba(85,63,50,1) 51%, rgba(42,31,25,1) 100%)')
				]),
			_List_fromArray(
				[
					A2(
					$author$project$Style$Title$styleTitle,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Game Rules')
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
							A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'margin-left', '20%'),
							A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'margin-right', '20%')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Winning Condition')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('1. Your score reaches 1000 points.')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('2. Your opponent\'s ball falls off the board.')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('3. Your opponent\'s block reaches the bottom.')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Game Setting')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('You can choose your hero at the bottom of the screen, each hero has his unique skill.')
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							A2(
							$author$project$Style$Button$styleButton,
							_List_fromArray(
								[
									A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'margin-left', '43%'),
									A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'width', '120%')
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Back to Menu')
								]))
						]))
				]))
		]));
var $author$project$Rule$main = $rtfeldman$elm_css$Html$Styled$toUnstyled($author$project$Rule$view);
_Platform_export({'Rule':{'init':_VirtualDom_init($author$project$Rule$main)(0)(0)}});}(this));